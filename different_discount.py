...
cmap = sns.color_palette('winter', 22)
...
colors = ['deeppink', 'indigo', 'tab:blue', 'orange']
plt.figure(figsize=(5, 4), dpi=100)

for i_dfe, discount_factor_cost in enumerate(discount_factors_cost):
    ...
    for i in range(5):
        s, a = mdp_algms.forward_runs_prob(
            ...
            T, beta)
        plt.plot(s/2, color=colors[i_dfe])
